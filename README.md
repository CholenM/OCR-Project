...
## Architecture
* **Core Model:** Qwen3-VL-2B-Instructed-GGUF *Stable* & PaddleOCR-VL-1.5 *Experimental*
...
* [ ] Table and complex font recognition *depends on the LLM used*
...
* **Setup:** Context Size 8000 vs 16,000
